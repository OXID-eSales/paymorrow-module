...
class Unit_Module_Controllers_OxpsPaymorrowPaymentTest extends OxidTestCase
{
    ...
    {
        modConfig::setParameter('paymentid', '');
    ...
    {
        modConfig::setParameter('paymentid', 'COD');
    ...
    {
        modConfig::setParameter('paymentid', 'invoice');
        modSession::getInstance()->setVar('pm_verify', array('pm_paymentMethod_name' => 'INVOICE'));
        modSession::getInstance()->setVar('pm_responseINVOICE', array());
    ...
    public function testValidatePayment_paymentMethodIsOkAndPaymorrowResponseStatusEmpty_returnNull()
    {
        modConfig::setParameter('paymentid', 'invoice');
        modSession::getInstance()->setVar('pm_verify', array('pm_paymentMethod_name' => 'INVOICE'));
        modSession::getInstance()->setVar('pm_responseINVOICE', array('order_status' => 'VALIDATED'));
    ...
    public function testValidatePayment_paymentMethodIsOkAndPaymorrowResponseOrderStatusEmpty_returnNull()
    {
        modConfig::setParameter('paymentid', 'invoice');
        modSession::getInstance()->setVar('pm_verify', array('pm_paymentMethod_name' => 'INVOICE'));
        modSession::getInstance()->setVar('pm_responseINVOICE', array('response_status' => 'OK'));
    ...
    {
        modConfig::setParameter('paymentid', 'invoice');
        modSession::getInstance()->setVar('pm_verify', array('pm_paymentMethod_name' => 'SDD'));
        modSession::getInstance()->setVar(
